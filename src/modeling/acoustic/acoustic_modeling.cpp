...
{
    std::string receiver_output_name = receiver_output_folder + "seismogram_acoustic_" + std::to_string(geometry->fRel[0]) + "x" + std::to_string(total_nodes) + "_shot_" + std::to_string(shot_id+1) + ".bin";
